...
We acknowledge the work done on the [JWST Science Calibration Pipeline](https://jwst-pipeline.readthedocs.io/en/stable/jwst/introduction.html), which we use for the initial imaging reduction steps. We also make use of [FITSMap](https://arxiv.org/abs/2201.12308), developed by Ryan Hausen and Brant Robertson, for our data viewers. 
